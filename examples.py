...
# data = getBoardIds('bilalmalik1561')
# print(data)
...
def pin(board_id='593138282113550766',
        section_id=None,
...
def upload_pin(board_id='593138282113550766',
               section_id=None,
               image_path='cred_root/download.jpeg',
               description='this is auto pin',
               title='a bot did this',
               link='https://www.google.com/'):
...
def unfollow_board(board_id='593138282113550766'):
...
# pin(board_id='Coder', section_id='Screenshots')


# Careful with category names. They have different names than as shown on Pinterest
def create_board(name='Laravel Framework',
